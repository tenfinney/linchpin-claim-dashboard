...
## Documentation of this project bootstrap in React Nodejs
...
## Reporting Issues
GitHub Issues is the official bug tracker for the Black Dashboard React. Here are some advices for our users that want to report an issue:

1. Make sure that you are using the latest version of the Black Dashboard React. 
2. Providing us reproducible steps for the issue will shorten the time it takes for it to be fixed.
3. Some issues may be browser specific, so specifying in what browser you encountered the issue might help.

## Technical Support or Questions

If you have questions or need help integrating the product please [contact us](https://web3vm.com) instead of opening an issue.
...
More products from Web3 Legal Engineering: <https://web3vm.com>
...
Twitter: <https://twitter.com/tenfinney>


# linchpin-claim-dashboard
